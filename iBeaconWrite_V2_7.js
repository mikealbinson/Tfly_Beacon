...
/******************************************************************************
 * Bluetooth manager and top of the command heirachy of the Ticektfly_Beacon
 ******************************************************************************/


/******************************************************************************
 * Initial bluetooth reset to run once
 ******************************************************************************/
...
child.exec('hciconfig hci0 up', function (error, stdout, stderr){
  console.log('stdout: ' + stdout);
    ...
    setTimeout(beginBroadcasting, 1000);
  });
}

/******************************************************************************
 * Init of the rest of the modules
 ******************************************************************************/
